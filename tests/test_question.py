...
class TestQuestion(BaseTestCase):
    ...
    def test_if_questions_class_exists(self):
        question = Question(1, 1, "git", "github", "version control")
    ...
    def test_if_json_data(self):
        ...
        with self.client:
            ...
            response = self.post_question(token,  1,"git", "github", "version control")
    ...
    def test_auth_to_post_question(self):
        ...
        """
        with self.client:
            response = self.post_question("id",  1,"git", "github", "version control")
            data = json.loads(response.data.decode())
